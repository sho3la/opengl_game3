...
private:
	...
	vector< vector<glm::vec3> > vVertices; 
	vector <vector< int > > vNormals;
	vector<int> glCommands; 

	vector<CVertexBufferObject> vboFrameVertices; 

	CVertexBufferObject vboTextureCoords; 

	vector<int> renderModes; 
	vector<int> numRenderVertices; 
